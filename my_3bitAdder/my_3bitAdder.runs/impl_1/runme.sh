...
HD_PWD='C:/Verilog/my_3bitAdder/my_3bitAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my3bitAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my3bitAdder.tcl -notrace
