...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CLK_MAX" -parent ${Page_0}
...
proc update_PARAM_VALUE.CLK_MAX { PARAM_VALUE.CLK_MAX } {
	# Procedure called to update CLK_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CLK_MAX { PARAM_VALUE.CLK_MAX } {
	# Procedure called to validate CLK_MAX
	return true
}
...
proc update_MODELPARAM_VALUE.CLK_MAX { MODELPARAM_VALUE.CLK_MAX PARAM_VALUE.CLK_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CLK_MAX}] ${MODELPARAM_VALUE.CLK_MAX}
}
