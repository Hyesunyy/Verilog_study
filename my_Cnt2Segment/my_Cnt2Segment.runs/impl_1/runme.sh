...
HD_PWD='C:/Verilog/my_Cnt2Segment/my_Cnt2Segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_Cnt2Segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_Cnt2Segment.tcl -notrace
