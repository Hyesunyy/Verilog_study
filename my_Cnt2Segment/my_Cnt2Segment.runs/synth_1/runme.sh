...
HD_PWD='C:/Verilog/my_Cnt2Segment/my_Cnt2Segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_Cnt2Segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_Cnt2Segment.tcl
