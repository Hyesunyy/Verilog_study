...
HD_PWD='C:/Verilog/my_TrafficLight/my_TrafficLight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_TrafficLight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_TrafficLight.tcl -notrace
