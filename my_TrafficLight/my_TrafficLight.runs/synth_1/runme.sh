...
HD_PWD='C:/Verilog/my_TrafficLight/my_TrafficLight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_TrafficLight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_TrafficLight.tcl
