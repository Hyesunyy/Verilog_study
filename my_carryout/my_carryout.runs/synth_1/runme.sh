...
HD_PWD='C:/Verilog/my_carryout/my_carryout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_carryout4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_carryout4.tcl
