...
HD_PWD='C:/Verilog/my_sw2segment/my_sw2segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw2segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw2segment.tcl -notrace
