...
HD_PWD='C:/Verilog/my_sw2segment/my_sw2segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw2segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw2segment.tcl
